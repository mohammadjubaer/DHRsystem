...
<div class="grid-item">
  <div class="button-container">
    <button onclick="toggleForm('historyForm')">Add History</button>
    <button onclick="toggleForm('adviceForm')">Add Advice</button>
    <button onclick="toggleForm('medicationForm')">Add Medication</button>
    <button onclick="toggleForm('labTestForm')">Add Lab Test</button>
    <button onclick="toggleForm('diagnosisForm')">Add Diagnosis</button>
   
  </div>
  <div id="historyForm" class="form-container" style="display: none;">
  <h2>Add History</h2>
  <form action="dataphp/history.php" method="post">
  ...
  <div id="adviceForm" class="form-container" style="display: none;">
  <h2>Add Advice</h2>
  <form action="dataphp/advice.php" method="post">
    <input type="text" name="patientID" placeholder="Patient ID" required />
    <input type="date" name="date" required />
    <textarea name="description" placeholder="Advice Text" required></textarea>
    <button type="submit">Submit</button>
  </form>
  </div>
  <div id="medicationForm" class="form-container" style="display: none;">
  <h2>Add Medication</h2>
  <form id="medicationFormContent" action="dataphp/medication.php" method="post">
    <input type="text" name="patientID" placeholder="Patient ID" required />
    <input type="date" name="date" required />
  ...
  <h2>Add Lab Test</h2>
  <form id="labTestFormContent" action="dataphp/labtest.php" method="post" >
    <input type="text" name="patientID" placeholder="Patient ID" required />
  ...
  <div id="diagnosisForm" class="form-container" style="display: none;">
  <h2>Add Diagnosis</h2>
  <form id="diagnosisFormContent" action="dataphp/diagonis.php" method="post">
    <input type="text" name="patientID" placeholder="Patient ID" required />
    <input type="text" name="doctorID" placeholder="Doctor ID" required />
    <input type="date" name="date" required />
